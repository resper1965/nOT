# PROC-004: [TÍTULO DO PROCEDIMENTO]
...
| KPI | Meta | Medição |
|-----|------|---------|
| [KPI 1] | [META] | [COMO MEDIR] |

## 7. REFERÊNCIAS

- Política relacionada: POL-XXX
- Norma: [NORMA APLICÁVEL]

## 8. ANEXOS

[TEMPLATES, CHECKLISTS, EXEMPLOS]

---

**Localização**: docs/procedures/PROC-004-[nome].md  
**Código DB**: PROC-004
